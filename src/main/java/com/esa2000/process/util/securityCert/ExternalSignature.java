/*
 * $Id: ExternalSignature.java 6134 2013-12-23 13:15:14Z blowagie $
 *
...
public interface ExternalSignature {
     ...
     * @return
     */
    public byte[] encrypt(byte[] message) throws BadPaddingException, IllegalBlockSizeException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException;
     ...
     * @return
     */
    public byte[] decrypt(byte[] message) throws InvalidKeyException, BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, NoSuchPaddingException;
}
