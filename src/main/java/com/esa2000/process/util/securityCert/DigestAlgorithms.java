/*
 * $Id: DigestAlgorithms.java 6134 2013-12-23 13:15:14Z blowagie $
 *
...
import com.esa2000.process.exception.BadRequestException;
import com.esa2000.process.exception.dto.ExceptionCode;
...
public class DigestAlgorithms {
    ...
    static {
        ...
        digestNames.put("1.2.840.113549.2.5", "MD5");
        digestNames.put("1.2.156.197.1.401", "SM3");
        ...
        allowedDigests.put("SM3", "1.2.156.197.1.401");
    }
    ...
    public static byte[] digest(InputStream data, String hashAlgorithm, String provider) {
        ...
        try {
            messageDigest = getMessageDigest(hashAlgorithm, provider);
            return digest(data, messageDigest);
        } catch (NoSuchAlgorithmException e) {
            throw new BadRequestException(ExceptionCode.DIGEST_ALGORITHMS_ERROR,e);
    ...
    public static byte[] digest(byte[] data,String hashAlgorithm,String provider){
        MessageDigest messageDigest = null;
        try {
            messageDigest = getMessageDigest(hashAlgorithm, provider);
